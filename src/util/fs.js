...
exports.mapAccountsFromCache = exports.readTestValidatorTemplate = exports.skipDownloadedAccounts = exports.writeAccountsToCacheFolder = exports.readSchema = exports.deleteFolderRecursive = exports.createScript = exports.createFile = exports.findFilesRecursively = exports.compileIgnoreFiles = void 0;
...
function readSchema(schemaFile) {
    return new Yaml2Solana_1.Yaml2SolanaClass(schemaFile);
}
 ...
 */
function mapAccountsFromCache(schema) {
    const cacheFolder = schema.localDevelopment.accountsFolder;
    cacheFolderMustExist(cacheFolder);
