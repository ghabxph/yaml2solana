    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (programLoop[0]) {
            ...
            if (choice === CHOICE_SETUP_USER_WALLET) {
                yield (0, setupUserWalletUi_1.setupUserWalletUi)();
            }
            if (choice === CHOICE_WALLET_OPTIONS) {
                yield (0, setupUserWalletUi_1.walletOptionsUi)();
            }
            if (choice === DOWNLOAD_SOLANA_ACCOUNTS) {
                return yield downloadSolanaAccounts(schemaFile, y2s);
            }
            if (choice === CHOICE_RUN_TEST_VALIDATOR) {
                return yield runTestValidator(schemaFile, y2s);
            }
